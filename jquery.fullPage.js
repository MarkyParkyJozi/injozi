...
//     $section2.css('-webkit-transform', 'skewY(0deg)');
// });

 var $section3 = $('#section2');
// $section3.on('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend',function (e) {
//     $section3.css('-webkit-transform', 'skewY(0deg)');
// });
        ...
        function skewSectionsTransition(element){
            var currentID = element[0].id;
            var $currSection = $("#" + currentID);
            var currentIDNo = currentID.slice(-1);
            var $nextSection = $("#" + currentID.slice(0, - 1) + (parseInt(currentIDNo)+1));


            //TweenMax.to($($currSection),1, {repeat: 1, yoyo: true, skew: '+=15'});
            //TweenMax.to($($currSection.find(".content")), 1, {repeat: 1, yoyo: true, skew: '-=15'});
            //
           ...
           // TweenMax.from ($currSection.find(".content"), 1, {transformMatrix:{skewY2:40}, ease:Quad.easeInOut});
            ...
            //$nextSection.css('-webkit-transform', 'skewY(15deg)');
            //$nextSection.find(".content").css('-webkit-transform', 'skewY(-15deg)');
            //
            //$('.creditsLink').animate({opacity:'1'},150,function(){
            //    $('.section-svg-holder .line').animate({opacity:'0.2'},190);
            //    $('.blueoverlay').delay(100).css({'display':'none'});
            //
            //});

            // $currSection.on('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend',function (e) {
            //     $currSection.css('-webkit-transform', 'skewY(0deg)');
            //     $currSection.find(".content").css('-webkit-transform', 'skewY(0deg)');
            // });
            // $nextSection.on('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend',function (e) {
            //     $nextSection.css('-webkit-transform', 'skewY(0deg)');
            //     $nextSection.find(".content").css('-webkit-transform', 'skewY(0deg)');
            // });

            // $section1.css('-webkit-transform', 'skewY(15deg)');
            // $('#content0').css('-webkit-transform', 'skewY(-15deg)');
            // $section2.css('-webkit-transform', 'skewY(15deg)');
            // $section3.css('-webkit-transform', 'skewY(15deg)');
        }
        ...
        function scrollPage(element, callback, isMovementUp){
            skewSectionsTransition(element);
